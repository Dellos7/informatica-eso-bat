Este es el repositorio de la página web del profesor de informática de ESO y Bachillerato David López Castellote, publicada en https://dlopezcastellote.dev/informatica-eso-bat/

Esta página web se utiliza para que el alumnado pueda seguir los apuntes, actividades y prácticas en el día a día de las clases. Para hacer entrega de las actividades finalizadas, el alumnado utilizará la plataforma Aules, basada en Moodle, de la Generalitat Valenciana.

Los contenidos de apuntes y actividades de cada asignatura se encuentran dentro de la carpeta llamada asignaturas, y cada una de ellas contiene sus propios materiales.

Las asignaturas son: 

- 1º ESO (TRDR: Taller de Relaciones Digitales Responsables)
- 2º ESO (PIARI: Programación, Inteligencia Artificial y Robótica I)
...
En general, dentro de la carpeta de cada asignatura tendremos distintas carpetas para cada una de las actividades. Por ejemplo, dentro de asignaturas/digitalizacion tenemos las carpetas actividad1, actividad2, actividad3...
...
Por último, el agente de IA deberá tener en cuenta las directrices del profesor para el desarrollo de la página web. Si el agente de IA considera oportuno hacer algún cambio en la programación, deberá consultar al profesor para que dé su consentimiento explícito. Sin embargo, el agente de IA podrá sugerir cambios en la programación de aula, siempre y cuando estén justificados y sean coherentes con el nivel de los alumnos y con los objetivos que se persiguen.
