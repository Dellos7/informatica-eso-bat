...
| :--- | :--- | :--- | :--- | :--- |
| **Actividad 1:** Entorno de servidor local: Virtualización con Linux Mint, Stack XAMPP y WordPress. | Aula de informática. | 15 sesiones. | VirtualBox, ISO de Linux Mint, XAMPP for Linux, WordPress, Blocksy, Elementor, All-in-One WP Migration, Bitwarden. | Guías visuales paso a paso, plantillas adaptadas y apoyo en parejas heterogéneas. |
